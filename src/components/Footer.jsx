...
export default function Footer() {
  return (
    <FooterContainer>
      ...
      <Links>
        <nav>
          <a href="https://github.com/HalisterFernando" target="_blank" rel="noopener noreferrer"><BsGithub /></a>
          <a href="https://www.linkedin.com/in/halister-fernando-santos/" target="_blank" rel="noopener noreferrer"><BsLinkedin /></a>
          <a
